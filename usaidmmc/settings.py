# Django settings for MomConnect KZN
...
DATABASES = {
    'default': dj_database_url.config(default='postgres:///usaidmmc'),
}
...
ROOT_URLCONF = 'usaidmmc.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'usaidmmc.wsgi.application'
